...
const navItems = ['Home-home', 'Unregistered-unregistered', 'Registered-registered', 'Vehicles-vehicles'];   //nav items list with corresponding navLinks
                ...
                <AppBar component="nav" sx={{ backgroundColor: '#000000' }}>
                    <Toolbar>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Typography noWrap sx={{ pr: 1 }}>{"Admin"}</Typography>
