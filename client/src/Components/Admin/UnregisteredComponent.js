...
const UnregisteredComponent = () => {
  ...
  return (
    <Container >
        <TableContainer>
            <Typography variant="h4" marginY={3} gutterBottom>
            ...
            <Table aria-label="simple table">
                ...
                {rows.map((row) => (
                    ...
                    <TableCell align="center">
                        <Button onClick={handleClickOpen} sx={{backgroundColor:"white","&:hover": {backgroundColor: "#dadada"
    }, color :"black", borderRadius: 10}}>View Details</Button>
                    </TableCell>
    ...
    }, color: "black", borderRadius: 3, paddingX: "30px"}}>Register All</Button>
            </Grid>
            </Grid>
        </TableContainer>
        ...
        <Dialog open={open} onClose={handleClose}>
            <DialogTitle align='center'>Station Details</DialogTitle>
            <DialogContent>
