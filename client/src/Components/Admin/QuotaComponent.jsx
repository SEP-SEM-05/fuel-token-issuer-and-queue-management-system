    ...
    return (
        <Container >
            <TableContainer >
                ...
                <Table sx={{ borderRadius: 4, }} style={{backgroundColor:"#282835"}} aria-label="simple table">
                    <TableHead>
                        <TableRow >
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <Typography variant='subtitle1' sx={{ fontWeight: 'bold', my:1 }} >
                        <Chip label={isPetrol ? "Petrol" : "Diesel"} color={ isPetrol ? 'warning' : 'success'} />
                    </Typography>
                ...
                <DialogActions sx={{ pr: 3, pl: 3, pb: 3 }}>
                    <Button variant='outlined' color={isPetrol ? 'warning' : 'success'} sx={{ width: "100%" }} >CHANGE</Button>
                </DialogActions>
            </Dialog>
        </Container>
    )
